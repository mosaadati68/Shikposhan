...
<div class="main main-raised">
    ...
    <div class="section section-navbars cd-section" id="navigation">
        ...
        <!--             navbar -->
        <div id="navbar">
            <div class="navigation-example" style="background-image: url('/img/kit/bg.jpg');">
        ...
        <div class="container tim-container">
            ...
            <div id="images">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <h4>Rounded Image</h4>
                        <img src="/img/kit/faces/avatar.jpg" alt="Rounded Image" class="rounded img-fluid">
                    </div>
                    ...
                    <div class="col-sm-2 ml-auto">
                        ...
                        <img src="/img/kit/faces/avatar.jpg" alt="Raised Image" class="img-raised rounded img-fluid">
                    </div>
                    <div class="col-sm-2 ml-auto">
                        <h4>Circle Raised</h4>
                        <img src="/img/kit/faces/avatar.jpg" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
                    </div>
                </div>
                <div class="row">
                </div>
    ...
    <div class="section section-signup page-header" style="background-image: url('/img/kit/free/city.jpg');">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="examples/landing-page.html" target="_blank">
                        <img src="/img/kit/free/landing.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
                        <button class="btn  btn-link btn-primary btn-lg">View Landing Page</button>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="examples/profile-page.html" target="_blank">
                        <img src="/img/kit/free/profile.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
